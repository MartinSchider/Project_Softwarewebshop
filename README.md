...
Order management
Improve graphics
Gift Card (payment) working
24/11/2025


Automatic email to the customer when the order is complete
...
DB CLIENT:
ID_CLIENT (P.K.) - NAME - SURNAME - ADDRESS
DB PRODUCT
ID_PRODUCT (P.K.) - NAME – COMPANY -  QUANTITY – PRICE – EXPIRING DATE
DB ORDER
ID_ORDER (P.K.) – REF_CLIENT – REF_PRODUCT
(REF_PRODUCT = ID_PRODUCT IN PRODUCT),(REF_CLIENT = ID_CLIENT IN CLIENT)
